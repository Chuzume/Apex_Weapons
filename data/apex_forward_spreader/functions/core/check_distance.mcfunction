...
#
# @within function apex_forward_spreader:core/randomizer
...
# while ((x^2+y^2) > r^2) randomizer
    ...
    execute if score $Temp ForwardSpreader > $Radius^2 ForwardSpreader run function apex_forward_spreader:core/randomizer
# リセット
