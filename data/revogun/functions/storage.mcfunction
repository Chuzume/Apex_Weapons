...
# いろいろする
    ...
    execute if data storage chuz:context Item.Mainhand.tag{ItemName:TechKit_Revo_Reloader} run tag @s add Revo.NowNormal
...
# ADS
    ...
    execute if data storage chuz:context Item.Mainhand.tag{ItemName:TechKit_Revo_Reloader,ItemMode:ADS} run tag @s add Revo.NowADS
