...
# X軸
    ...
    execute if entity @s[tag=Col_Hit_X] run function revogun:move
...
# Y軸 
    ...
    execute if entity @s[tag=Col_Hit_Y] run function revogun:move
...
# Z軸
    ...
    execute if entity @s[tag=Col_Hit_Z] run function revogun:move
