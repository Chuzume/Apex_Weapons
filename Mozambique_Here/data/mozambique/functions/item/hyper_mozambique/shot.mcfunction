...
# 発砲!
    ...
    scoreboard players set $CMD Chuz.Temporary 18
    scoreboard players reset @s C.Apex_Delay
    tag @s add C.Apex_NormalShot

# リコイル
    execute if score $C.Apex_Gamerule C.Apex_Gamerule1 matches 1 run scoreboard players set @s C.Apex_Rec.Moza 9
