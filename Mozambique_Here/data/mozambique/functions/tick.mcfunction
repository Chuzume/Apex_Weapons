...
# 弾丸
    ...
    execute as @e[type=armor_stand,tag=C.Apex_WingBullet] at @s run function mozambique:entity/wingman_bullet/tick
...
# リコイル
    execute as @a[scores={C.Apex_Rec.Wing=0..}] at @s run function mozambique:item/wingman/recoil
    execute as @a[scores={C.Apex_Rec.Wing2=0..}] at @s run function mozambique:item/wingman/recoil
    execute as @a[scores={C.Apex_Rec.Moza=0..}] at @s run function mozambique:item/mozambique/recoil
