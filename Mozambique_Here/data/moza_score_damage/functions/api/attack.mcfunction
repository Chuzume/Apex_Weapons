...
# Healthを持つEntityであれば実行
    execute if data storage moza_score_damage: Damage if entity @s[type=!#mozambique:unhurtable,type=!ender_dragon,nbt={Invulnerable:0b}] run function moza_score_damage:core/attack
